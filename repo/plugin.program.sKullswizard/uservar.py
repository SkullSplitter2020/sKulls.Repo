...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR indianred][B]sKulls [/B][/COLOR]Wizard'
BUILDERNAME = 'sKullswizard'
EXCLUDES = [ADDON_ID, 'plugin.program.sKullswizard']
# Text File with build info in it.
BUILDFILE = 'http://skulls-inc.bplaced.net/Kodi/wiz/texts/builds.txt'
# How often you would like it to check for build updates in days
# 0 being every startup of kodi
UPDATECHECK = 0
# Text File with apk info in it.  Leave as 'http://' to ignore
APKFILE = 'http://skulls-inc.bplaced.net/Kodi/wiz/texts/apk.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]sKulls[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Danke, dass du das sKulls Build verwendest.\nCheers SkullSplitter'
...
REPOID = 'repository.skulls.build'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://'
# Url to folder zip is located in
REPOZIPURL = 'http://skulls-inc.bplaced.net/Kodi/repo/repository.skullsbuild.zip'
#########################################################
...
NOTIFICATION = 'http://skulls-inc.bplaced.net/Kodi/wiz/texts/notify.txt'
# Use either 'Text' or 'Image'
HEADERTYPE = 'Text'
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR indianred][B]sKulls [/B][/COLOR]Wizard'
